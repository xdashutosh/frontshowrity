...
if (token) {
  ...
  <Header/>
      ...
      <ModalContent h={'60vh'}  >
      <ModalCloseButton />    
      <Stack w={['','full']} h={['','full']} direction={['column','column','row']} spacing={'0'} boxSize={'borderbox'}>
      <VStack h={['0%','0%','full']} w={'full'} p={'-1'}  >
      <Image h={['0%','0%','full']} w={['0%','0%','full']} rounded="md" objectFit={'cover'} src='https://media.istockphoto.com/id/637229346/photo/teamwork-holds-the-capacity-for-increased-productivity.jpg?s=612x612&w=0&k=20&c=mFU5BPJXcLc7zEOXoFT3eb0V6n9Y3RAf60VkY4PfIZw='/>
      ...
      <VStack h={'full'} w={'full'} p={'4'} >
          ...
          <Link to={'/register'} className='w-full' >
           <Button w={'full'} letterSpacing={'widest'} variant="unstyled" bgColor="#1c1c1c" textColor="white">Signup</Button>
          </Link>
        ...
        <p className='text-2xl text-[#1C1C1C] font-bold my-4'>Top rated Souls in <span className='text-[#22495baa]'>Animated Explainers</span>  </p>
        ...
        
        {
          data.map((item,i)=>(
            <>
              ...
              <Link to='/allDeveloper'>   <p className=' cursor-pointer hover:text-[#EEEEEE] hover:bg-[#176B87] bg-[#1C1C1C] px-3 py-2 text-[#FFFFFF] w-18 font-bold rounded-lg '>EXPLORE</p> 
              </Link>
