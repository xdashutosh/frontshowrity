...
import { InputGroup, InputLeftElement, Input, Box, List, ListItem, VStack, InputRightElement, Button, Text, HStack } from '@chakra-ui/react';
...
function Searchbarfilterpage() {
  ...
  const handledata = async() => {
    try {  
      ...
      Navigate(`/filterdeveloper/${search}`)
  ...
  return (
    ...
    <Box py={'4'} position="relative" width={['90%',"60%"]}>
    <InputGroup>
      <InputLeftElement pointerEvents="none">
        <FiSearch color="gray.400" />
         ...
         <Button bgColor={'#1c1c1c'}  borderRadius="full" variant={'outline'} textColor={'white'} px={['8','12']} fontSize={['xs','md']} _hover={{textColor:'black',bgColor:'white'}} onClick={handledata}>Search</Button>
         </InputRightElement>
      <Input
        value={inputValue}
...
export default Searchbarfilterpage;
